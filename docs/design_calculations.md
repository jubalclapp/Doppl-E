...
<br>
As shown in the table, a high estimate for the speed of a car moving on a highway is about 105km/h, or 65mph. To find the corresponding intermediate frequency, we can use Equation 10 found in Section 2.1. <br>
